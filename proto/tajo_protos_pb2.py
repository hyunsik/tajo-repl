...
_sym_db.RegisterEnumDescriptor(_QUERYSTATE)
...
_sym_db.RegisterEnumDescriptor(_TASKATTEMPTSTATE)
...
_sym_db.RegisterEnumDescriptor(_FETCHERSTATE)
...
_NODERESOURCEPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='memory', full_name='NodeResourceProto.memory', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='virtual_cores', full_name='NodeResourceProto.virtual_cores', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disks', full_name='NodeResourceProto.disks', index=2,
...
DESCRIPTOR.enum_types_by_name['QueryState'] = _QUERYSTATE
DESCRIPTOR.enum_types_by_name['TaskAttemptState'] = _TASKATTEMPTSTATE
DESCRIPTOR.enum_types_by_name['FetcherState'] = _FETCHERSTATE

WorkerConnectionInfoProto = _reflection.GeneratedProtocolMessageType('WorkerConnectionInfoProto', (_message.Message,), dict(
  DESCRIPTOR = _WORKERCONNECTIONINFOPROTO,
  __module__ = 'tajo_protos_pb2'
  # @@protoc_insertion_point(class_scope:WorkerConnectionInfoProto)
  ))
_sym_db.RegisterMessage(WorkerConnectionInfoProto)

NodeResourceProto = _reflection.GeneratedProtocolMessageType('NodeResourceProto', (_message.Message,), dict(
  DESCRIPTOR = _NODERESOURCEPROTO,
  __module__ = 'tajo_protos_pb2'
  # @@protoc_insertion_point(class_scope:NodeResourceProto)
  ))
_sym_db.RegisterMessage(NodeResourceProto)
